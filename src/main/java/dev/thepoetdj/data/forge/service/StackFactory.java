...
public final class StackFactory {
     ...
     * @return an {@code Optional} containing the instance of a fixed capacity
     *         {@code Stack}, or an empty {@code Optional} when capacity is
     *         negative or zero.
     *
     * @since 0.1.0
     */
    ...
    /**
     * Initializes a {@link Stack} with no predefined capacity. The stack will
     * be allowed to grow dynamically, limited only by the available free memory
